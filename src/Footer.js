    ...
    return (
        <div className="footer-container">
            <footer class="footer">
                ...
                <div class="row">
                        ...
                        <div class="footer-widget">
                                <h4 class="mb-4">Artista</h4>
                                <p class="lead">Artista Ecommerce Pvt. Ltd., 220, </p>
                                
                                <div class="">
                                    <p class="mb-0"><strong>Location : </strong>Rawalpindi, Punjab, Pakistan</p>
                        ...
                        <div class="col-md-6 col-lg-2 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left">
                            ...
                            <li><a href="#">Watercolor Paintings</a></li>
                            <li><a href="#">Acrylic Paintings</a></li>
                            <li><a href="#">Islamic Calligraphy</a></li>
                            <li><a href="#">Handmade Sketches</a></li>
                        ...
                        <div class="col-md-6 col-lg-3 col-sm-6 text-center text-sm-left">
                            ...
                            <h5>Call Now : +(92) 311-977-6950</h5>
                        </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-btm py-4 ">
                ...
                <div class="row ">
                        <div class="col-lg-6">
                            <p class="copyright mb-0 ">@ Copyright Reserved to Artista &amp; made by <a href="#">Love</a></p>
                        </div>
                        <div class="col-lg-6">
