                            ...
                            <table class="table shop_table shop_table_responsive cart" cellspacing="0">
                                ...
                                <tr class="cart_item">
                                    <td class="product-thumbnail" data-title="Thumbnail">
                                        <a href="/product-single"><img src="assets/images/322-rep.png" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" /></a>
                                    </td>
        
                                    <td class="product-name" data-title="Product">
                                        <a href="#">Trendy Paintings</a>
                                    </td>
