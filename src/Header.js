    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-white w-100 navigation" id="navbar">
            <div className="container">
                <Link className="navbar-brand font-weight-bold" to={{ pathname: "/" }}>Artista</Link>
                        ...
                        <div className="dropdown-menu cart-dropdown">
                            ...
                            <div className="media">
                                <a href="/product-single">
                                    <img className="media-object img- mr-3" src="assets/images/322-rep.png" alt="image" />
                                </a>
                            ...
                            <div className="media">
                                <a href="/product-single">
                                    <img className="media-object img-fluid mr-3" src="assets/images/322-rep.png" alt="image" />
                                </a>
                                <div className="media-body">
                                    <h6>Watercolor Painting</h6>
                                    <div className="cart-price">
